  ...
  resources: {
    en: {
      translation: {
        ...
        descReset: "Password reset link sent to your registered email address. Please check your inbox or spam folder",
        fileABig: "The file is too big",
        checkTheUserName: "Mistake!!! Check the username or that password",
        clickIfYouDontRememberYourPassword: "Click if you don’t remember your password",
    ...
    de: {
      translation: {
        ...
        filedToSend: "Daten konnten nicht gesendet werden, bitte versuchen Sie es erneut",
        ...
        descReset: "Link zum Zurücksetzen des Passworts an Ihre registrierte E-Mail-Adresse gesendet. Bitte überprüfen Sie Ihren Posteingang oder Spam-Ordner",
        fileABig: "Die Datei ist zu groß",
        checkTheUserName: "Überprüfen Sie den Benutzernamen und geben Sie das korrekte Passwort ein.",
        clickIfYouDontRememberYourPassword: "Klicken Sie, wenn Sie sich nicht an Ihr Passwort erinnern",
    ...
    fr: {
      translation: {
        ...
        emailNotForForgotPassword: "L'email n'est pas valable pour la récupération du mot de passe",
        ...
        descReset: "Le lien de réinitialisation du mot de passe a été envoyé à votre adresse e-mail enregistrée. Veuillez vérifier votre boîte de réception ou votre dossier de courrier indésirable.",
        fileABig: "Le fichier est trop grand",
        checkTheUserName: "Erreur ! Vérifiez le nom d'utilisateur ou le mot de passe",
        clickIfYouDontRememberYourPassword: "Cliquez si vous ne vous souvenez plus de votre mot de passe",
        ...
        deleteProfileConfirm: "Souhaitez-vous supprimer votre profil medicalswitzerland ?",
